...
while 1:
    ...
    mask1 = cv2.inRange(a_inv, 150, 255)
    ...
    mask2 = cv2.inRange(b_ch, 195, 255)
    org = image.copy()
    res1 = cv2.bitwise_and(org, org, mask=mask1)
    ...
    # orange
    #cv2.imshow("ab", np.hstack([a_ch, b_ch]))
    mask1 = cv2.inRange(a_ch, 155, 186)
    mask2 = cv2.inRange(b_ch, 180, 200)
    #cv2.imshow("Mask", np.hstack([mask1, mask2]))
    org = image.copy()
    res1 = cv2.bitwise_and(org, org, mask=mask1)
    ...
    # red
    #cv2.imshow("ab", np.hstack([a_ch, b_ch]))
    mask1 = cv2.inRange(a_ch, 180, 255)
    mask2 = cv2.inRange(b_ch, 100, 190)
    #cv2.imshow("Mask", np.hstack([mask1, mask2]))
    org = image.copy()
    res1 = cv2.bitwise_and(org, org, mask=mask1)
    ...
    mask1 = cv2.inRange(a_ch, 140, 190)
    mask2 = cv2.inRange(b_inv, 135, 190)
    #cv2.imshow("Mask", np.hstack([mask1, mask2]))
    org = image.copy()
    res1 = cv2.bitwise_and(org, org, mask=mask1)
    ...
    mask2 = cv2.inRange(b_inv, 155, 255)
    #cv2.imshow("Mask", np.hstack([mask1, mask2]))
    org = image.copy()
    res1 = cv2.bitwise_and(org, org, mask=mask1)
